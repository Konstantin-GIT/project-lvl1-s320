...
export const checkAnswer = (valueName,valueAnswer,valueRandom,counter) => {
  ...
  if (valueRandom % 2 === 0 && valueAnswer === 'yes')
  
   {console.log('Correct!');
    evenProgram(valueName,counter)}

     else { console.log(`'yes' is wrong answer ;(. Correct answer was 'no'. Let's try again, Bill! `);}
  };
...
export const evenProgram = (valueName,counter) => {
    ...
    let valueRandom = askQuestion();

    let valueAnswer = answerUser();
